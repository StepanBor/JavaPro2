...
public class ContactController {
    ...
    public String index(Model model, @RequestParam(required = false, defaultValue = "0") Integer page) {
        ...
        System.out.println(pageCount+"controller!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!");
        model.addAttribute("groups", contactService.listGroups());
        System.out.println(contactService.listGroups()+"controller!!!!!!!!!!!!!!!!!!!!");
        model.addAttribute("contacts", contactService.listContacts(null, start, ITEMS_PER_PAGE));
        System.out.println(contactService.listContacts(null, start, ITEMS_PER_PAGE)+"controller!!!!!!!!!!!!!!!!!!!!!!!!!!!");
        model.addAttribute("pages", pageCount+"controller!!!!!!!!!!!!!!!!!!!!!!!!!");
